...
import {
  ...
  RichTextMenu,
  Separator
} from "./chunk-32OVR7HJ.js";
import {
  styles_module_default
} from "./chunk-A6WJPCCR.js";
import {
  useShallow
} from "./chunk-TST5VVGC.js";
import "./chunk-EQ3SJVBA.js";
import "./chunk-YJNT5LT2.js";
import "./chunk-GRJIE5HV.js";
import {
  ChevronDown,
  ChevronRight,
  ChevronUp,
...
import {
  ...
  init_react_import
} from "./chunk-TIUV6YTH.js";
import {
  subscribeWithSelector,
  useStore
} from "./chunk-J72QCRIE.js";
import {
  require_react_dom
...
function useRichtextProps(fields, props) {
  ...
  const richtextProps = (0, import_react2.useMemo)(() => {
    ...
    const RichTextRender2 = (0, import_react2.lazy)(
      () => import("./Render-CU35UAWV-4CLIPI3G.js").then((m2) => ({
...
var useIsomorphicLayoutEffect = canUseDOM2 ? import_react4.useLayoutEffect : import_react4.useEffect;
function useForceUpdate() {
  const setState = (0, import_react4.useState)(0)[1];
  return (0, import_react4.useCallback)(() => {
    setState((value) => value + 1);
  }, [setState]);
}
function useDeepSignal(target, synchronous) {
  const tracked = (0, import_react4.useRef)(/* @__PURE__ */ new Map());
...
function useOnValueChange(value, onChange, effect3 = import_react4.useEffect, compare = Object.is) {
  const tracked = (0, import_react4.useRef)(value);
  effect3(() => {
...
function useOnElementChange(value, onChange) {
  const previous = (0, import_react4.useRef)(currentValue(value));
  useIsomorphicLayoutEffect(() => {
...
var DragDropContext = (0, import_react5.createContext)(
  defaultManager
);
var Renderer = (0, import_react5.memo)(
  (0, import_react5.forwardRef)(({ children }, ref) => {
    const [transitionCount, setTransitionCount] = (0, import_react5.useState)(0);
    const rendering = (0, import_react5.useRef)(null);
    const resolver = (0, import_react5.useRef)(null);
    const renderer = (0, import_react5.useMemo)(
      () => ({
        renderer: {
          get rendering() {
            var _a23;
    ...
    (0, import_react5.useImperativeHandle)(ref, () => renderer);
    return null;
  })
);
...
function DragDropProvider(_a23) {
  ...
  const [manager, setManager] = (0, import_react5.useState)((_a33 = input.manager) != null ? _a33 : null);
  ...
  (0, import_react5.useEffect)(() => {
    ...
    (0, import_react5.startTransition)(() => setManager(manager2));
...
function useDragDropManager() {
  return (0, import_react5.useContext)(DragDropContext);
}
function useInstance(initializer) {
  var _a23;
  const manager = (_a23 = useDragDropManager()) != null ? _a23 : void 0;
  const [instance] = (0, import_react5.useState)(() => initializer(manager));
...
function useDraggable(input) {
  ...
  return {
    ...
    handleRef: (0, import_react5.useCallback)(
      (element2) => {
        draggable.handle = element2 != null ? element2 : void 0;
      },
      [draggable]
    ),
    ref: (0, import_react5.useCallback)(
      (element2) => {
        var _a23, _b3;
...
function useSortable(input) {
  ...
  return {
    ...
    sourceRef: (0, import_react6.useCallback)(
      (element2) => {
        var _a5, _b3;
    ...
    targetRef: (0, import_react6.useCallback)(
      (element2) => {
        var _a5, _b3;
...
function useContextStore(context, selector) {
  const store2 = (0, import_react10.useContext)(context);
  if (!store2) {
...
function createStoreProvider(ContextComponent) {
  const StoreProvider = ({
    ...
    const [store2] = (0, import_react10.useState)(() => createStore(() => value));
...
function createContextStore(defaultValue) {
  const ctx = (0, import_react10.createContext)(
...
var useFieldStoreApi = () => (0, import_react9.useContext)(fieldContextStore.ctx);
function useFieldStore(selector) {
  const store2 = (0, import_react9.useContext)(fieldContextStore.ctx);
  if (!store2) {
    throw new Error("useContextStore must be used inside context");
  }
  return useStore(store2, useShallow(selector));
...
var ItemSummaryInner = ({
  ...
  const itemSummary = (0, import_react11.useMemo)(() => {
...
var ItemSummary = (0, import_react11.memo)(ItemSummaryInner);
var ArrayFieldItemInternal = ({
  ...
  const hasVisibleFields = (0, import_react11.useMemo)(() => {
...
var ArrayFieldItem = (0, import_react11.memo)(ArrayFieldItemInternal);
var ArrayField = ({
  field,
  onChange,
  id,
  ...
  const getArrayState = (0, import_react11.useCallback)(() => {
    var _a5;
  ...
  const defaultArrayState = (0, import_react11.useMemo)(getArrayState, [getArrayState]);
  ...
  const regenerateArrayState = (0, import_react11.useCallback)((value) => {
  ...
  const [draggedItem, setDraggedItem] = (0, import_react11.useState)("");
  const isDraggingAny = !!draggedItem;
  const valueRef = (0, import_react11.useRef)([]);
  (0, import_react11.useEffect)(() => {
    valueRef.current = getValue();
  }, []);
  const uniqifyItem = (0, import_react11.useCallback)(
    (val) => {
  ...
  const syncCurrentIndexes = (0, import_react11.useCallback)(() => {
    const arrayState = getArrayState();
...
var useLocalValue = (path, onChange) => {
  ...
  const [localValue, setLocalValue] = (0, import_react17.useState)(value == null ? void 0 : value.toString());
  const onChangeLocal = (0, import_react17.useCallback)((val) => {
    setLocalValue(val);
    onChange(val);
  }, []);
...
var Modal = ({
  ...
  const [rootEl, setRootEl] = (0, import_react20.useState)(null);
...
init_react_import();
init_react_import();
var EditorFallback = (0, import_react23.memo)((props) => {
  var _a5;
...
var Editor = (0, import_react22.lazy)(
  () => import("./Editor-NK3TZSR6-OVR2N37Y.js").then((m2) => ({
    default: m2.Editor
  }))
);
var RichtextField = ({
  ...
  return (0, import_jsx_runtime21.jsx)(import_jsx_runtime21.Fragment, { children: (0, import_jsx_runtime21.jsx)(
    Label2,
    {
      ...
      readOnly,
      el: "div",
      children: (0, import_jsx_runtime21.jsx)(import_react22.Suspense, { fallback: (0, import_jsx_runtime21.jsx)(EditorFallback, __spreadValues({}, editorProps)), children: (0, import_jsx_runtime21.jsx)(Editor, __spreadValues({}, editorProps)) })
    }
  ) });
};
init_react_import();
...
init_react_import();
var useSafeId = () => {
  if (typeof import_react24.default.useId !== "undefined") {
    return import_react24.default.useId();
  }
  const [id] = (0, import_react24.useState)(generateId());
  return id;
};
init_react_import();
...
var FieldLabelInternal = ({
  ...
  const Wrapper = (0, import_react25.useMemo)(
...
function AutoFieldInternal(props) {
  ...
  const nestedFieldContext = (0, import_react8.useContext)(NestedFieldContext);
  ...
  const mergedProps = (0, import_react8.useMemo)(
    () => __spreadProps(__spreadValues({}, props), {
      field,
      label,
      labelIcon,
  ...
  const onBlur = (0, import_react8.useCallback)((e2) => {
  ...
  let Children = (0, import_react8.useMemo)(() => {
  ...
  let FieldComponent = (0, import_react8.useMemo)(() => {
...
function AutoFieldPublicInternal(_a5) {
  ...
  const DefaultLabel = (0, import_react8.useMemo)(() => {
...
init_react_import();
var dropZoneContext = (0, import_react31.createContext)(null);
var ZoneStoreContext = (0, import_react31.createContext)(
  createStore(() => ({
    zoneDepthIndex: {},
    nextZoneDepthIndex: {},
    areaDepthIndex: {},
...
var DropZoneProvider = ({
  ...
  const dispatch = useAppStore((s2) => s2.dispatch);
  const registerZone = (0, import_react31.useCallback)(
    (zoneCompound) => {
      dispatch({
        type: "registerZone",
        zone: zoneCompound
  ...
  const memoValue = (0, import_react31.useMemo)(
    () => __spreadValues({
      registerZone
    }, value),
    [value]
...
var DraggableComponent = ({
  ...
  const [localZones, setLocalZones] = (0, import_react30.useState)({});
  const registerLocalZone = (0, import_react30.useCallback)(
  ...
  const unregisterLocalZone = (0, import_react30.useCallback)(
    (zoneCompound2) => {
      var _a5;
  ...
  const [dragAxis, setDragAxis] = (0, import_react30.useState)(userDragAxis || autoDragAxis);
  const dynamicCollisionDetector = (0, import_react30.useMemo)(
  ...
  const [, setRerender] = (0, import_react30.useState)(0);
  const ref = (0, import_react30.useRef)(null);
  const refSetter = (0, import_react30.useCallback)(
    (el) => {
      sortableRef(el);
      if (ref.current !== el) {
        ref.current = el;
  ...
  const [portalEl, setPortalEl] = (0, import_react30.useState)();
  (0, import_react30.useEffect)(() => {
    var _a5, _b3, _c4;
    setPortalEl(
  ...
  const getStyle = (0, import_react30.useCallback)(() => {
    var _a5, _b3, _c4;
  ...
  const [style, setStyle] = (0, import_react30.useState)();
  const sync = (0, import_react30.useCallback)(() => {
    setStyle(getStyle());
  }, [ref.current, iframe]);
  (0, import_react30.useEffect)(() => {
    if (ref.current) {
  ...
  const hideOverlay = (0, import_react30.useCallback)(() => {
    setIsVisible(false);
  }, []);
  const showOverlay = (0, import_react30.useCallback)(() => {
    setIsVisible(true);
  }, []);
  (0, import_react30.useEffect)(() => {
    var _a5;
  ...
  const CustomActionBar = (0, import_react30.useMemo)(
    () => overrides.actionBar || DefaultActionBar,
    [overrides.actionBar]
  );
  const CustomOverlay = (0, import_react30.useMemo)(
  ...
  const appStore = useAppStoreApi();
  const onSelectParent = (0, import_react30.useCallback)(() => {
  ...
  const onDuplicate = (0, import_react30.useCallback)(() => {
    dispatch({
      type: "duplicate",
      sourceIndex: index,
  ...
  const [hover, setHover] = (0, import_react30.useState)(false);
  ...
  const [isVisible2, setIsVisible] = (0, import_react30.useState)(false);
  const [dragFinished, setDragFinished] = (0, import_react30.useState)(true);
  const [_2, startTransition2] = (0, import_react30.useTransition)();
  (0, import_react30.useEffect)(() => {
    startTransition2(() => {
  ...
  const [thisWasDragging, setThisWasDragging] = (0, import_react30.useState)(false);
  ...
  const syncActionsPosition = (0, import_react30.useCallback)(
    (el) => {
      if (el) {
  ...
  const parentAction = (0, import_react30.useMemo)(
...
var useMinEmptyHeight = ({
  ...
  const appStore = useAppStoreApi();
  const [prevHeight, setPrevHeight] = (0, import_react34.useState)(0);
  ...
  const numItems = (0, import_react34.useRef)(0);
...
var useContentIdsWithPreview = (contentIds, zoneCompound) => {
  ...
  const [contentIdsWithPreview, setContentIdsWithPreview] = (0, import_react35.useState)(contentIds);
  const [localPreview, setLocalPreview] = (0, import_react35.useState)(
    preview
  );
...
var useDragAxis = (ref, collisionAxis) => {
  ...
  const [dragAxis, setDragAxis] = (0, import_react38.useState)(
    collisionAxis || DEFAULT_DRAG_AXIS
  );
  const calculateDragAxis = (0, import_react38.useCallback)(() => {
    if (ref.current) {
      const computedStyle = window.getComputedStyle(ref.current);
  ...
  (0, import_react38.useEffect)(calculateDragAxis, [status, collisionAxis]);
...
var renderContext = import_react39.default.createContext({
  config: { components: {} },
  data: { root: {}, content: [] },
  metadata: {}
});
function Render({
  ...
  const nextContextValue = (0, import_react39.useMemo)(
    () => ({
      mode: "render",
      depth: 0
    }),
...
function useFieldTransformsTracked(config, item, transforms, readOnly, forceReadOnly) {
  const prevProps = (0, import_react40.useRef)(null);
  const prevResult = (0, import_react40.useRef)(item.props);
  const mappers = (0, import_react40.useMemo)(
    () => buildMappers(transforms, readOnly, forceReadOnly),
    [transforms, readOnly, forceReadOnly]
  );
  const transformedProps = (0, import_react40.useMemo)(() => {
    var _a5, _b3, _c4;
    const changedProps = {};
  ...
  const mergedProps = (0, import_react40.useMemo)(
    () => __spreadValues(__spreadValues({}, item.props), transformedProps),
    [item.props, transformedProps]
  );
  return mergedProps;
...
var InlineTextFieldInternal = ({
  ...
  const [isHovering, setIsHovering] = (0, import_react41.useState)(false);
...
var InlineTextField = (0, import_react41.memo)(InlineTextFieldInternal);
...
init_react_import();
var Editor2 = (0, import_react42.lazy)(
  () => import("./Editor-NK3TZSR6-OVR2N37Y.js").then((m2) => ({
    default: m2.Editor
  }))
);
var RichTextRender = (0, import_react42.lazy)(
  () => import("./Render-CU35UAWV-4CLIPI3G.js").then((m2) => ({
    default: m2.RichTextRender
  }))
);
var InlineEditorWrapper = (0, import_react42.memo)(
  ({
    value,
    componentId,
    propPath,
    ...
    const portalRef = (0, import_react42.useRef)(null);
    const appStoreApi = useAppStoreApi();
    ...
    if (!field.contentEditable)
      return (0, import_jsx_runtime31.jsx)(import_react42.Suspense, { fallback: (0, import_jsx_runtime31.jsx)(RichTextRenderFallback, { content: value }), children: (0, import_jsx_runtime31.jsx)(RichTextRender, { content: value, field }) });
    const editorProps = {
      content: value,
    ...
    return (0, import_jsx_runtime31.jsx)(
      "div",
      {
        ...
        children: (0, import_jsx_runtime31.jsx)(import_react42.Suspense, { fallback: (0, import_jsx_runtime31.jsx)(EditorFallback, __spreadValues({}, editorProps)), children: (0, import_jsx_runtime31.jsx)(Editor2, __spreadValues({}, editorProps)) })
      }
    );
  }
);
...
var MemoizeComponent = (0, import_react43.memo)(RenderComponent, (prev, next) => {
  let puckEquals = true;
...
var DropZoneChild = ({
  ...
  const appStore = useAppStoreApi();
  const item = (0, import_react29.useMemo)(() => {
    if (nodeProps) {
  ...
  const puckProps = (0, import_react29.useMemo)(
    () => ({
  ...
  const defaultsProps = (0, import_react29.useMemo)(
  ...
  const defaultedNode = (0, import_react29.useMemo)(
    () => {
      var _a23;
  ...
  const combinedFieldTransforms = (0, import_react29.useMemo)(
...
var DropZoneChildMemo = (0, import_react29.memo)(DropZoneChild);
var DropZoneEdit = (0, import_react29.forwardRef)(
  function DropZoneEditInternal({
    ...
    const contentIds = (0, import_react29.useMemo)(() => {
    ...
    const setRefs = (0, import_react29.useCallback)(
      (node) => {
...
var DropZoneRender = (0, import_react29.forwardRef)(
  function DropZoneRenderInternal({ className, style, zone, as }, ref) {
    ...
    const { config, data, metadata } = (0, import_react29.useContext)(renderContext);
...
var DEBUG3 = false;
var dragListenerContext = (0, import_react28.createContext)({
  dragListeners: {}
});
function useDragListener(type, fn, deps = []) {
  const { setDragListeners } = (0, import_react28.useContext)(dragListenerContext);
...
var useTempDisableFallback = (timeout3) => {
  const lastFallbackDisable = (0, import_react28.useRef)(null);
  return (0, import_react28.useCallback)((manager) => {
...
var DragDropContextClient = ({
  ...
  const appStore = useAppStoreApi();
  const debouncedParamsRef = (0, import_react28.useRef)(null);
  const tempDisableFallback = useTempDisableFallback(100);
  const [zoneStore] = (0, import_react28.useState)(
    () => createStore(() => ({
      zoneDepthIndex: {},
      nextZoneDepthIndex: {},
      areaDepthIndex: {},
  ...
  const getChanged = (0, import_react28.useCallback)(
    (params) => {
  ...
  const setDeepestAndCollide = (0, import_react28.useCallback)(
    (params, manager) => {
  ...
  const [plugins] = (0, import_react28.useState)(() => [
  ...
  const sensors = useSensors();
  const [dragListeners, setDragListeners] = (0, import_react28.useState)({});
  const dragMode = (0, import_react28.useRef)(null);
  const initialSelector = (0, import_react28.useRef)(void 0);
...
var FieldsChildInner = ({ fieldName }) => {
  ...
  const appStore = useAppStoreApi();
  const onChange = (0, import_react46.useCallback)(createOnChange(fieldName, appStore), [
    fieldName
  ]);
  const { visible = true } = field != null ? field : {};
  const fieldStore = (0, import_react46.useContext)(fieldContextStore.ctx);
...
var FieldsChild = ({ fieldName }) => {
  const appStore = useAppStoreApi();
  const initialValue = (0, import_react46.useMemo)(() => {
    var _a5;
...
var FieldsChildMemo = (0, import_react46.memo)(FieldsChild);
var FieldsInternal = ({ wrapFields = true }) => {
  ...
  const Wrapper = (0, import_react46.useMemo)(() => overrides.fields || DefaultFields, [overrides]);
...
var Fields = (0, import_react46.memo)(FieldsInternal);
init_react_import();
init_react_import();
init_react_import();
init_react_import();
...
var useComponentList = () => {
  const [componentList, setComponentList] = (0, import_react47.useState)();
  const config = useAppStore((s2) => s2.config);
...
var Components = () => {
  ...
  const Wrapper = (0, import_react49.useMemo)(() => {
...
function AutoFrame(_a5) {
  ...
  const [stylesLoaded, setStylesLoaded] = (0, import_react51.useState)(false);
  (0, import_react51.useEffect)(() => {
    var _a23;
    if (frameRef.current) {
...
var Layer = ({
  ...
  const dispatch = useAppStore((s2) => s2.dispatch);
  const setItemSelector = (0, import_react52.useCallback)(
    (itemSelector2) => {
...
var Outline = () => {
  ...
  const Wrapper = (0, import_react53.useMemo)(() => outlineOverride || "div", [outlineOverride]);
...
var useInjectStyleSheet = (initialStyles, iframeEnabled) => {
  const [el, setEl] = (0, import_react57.useState)();
...
var usePreviewModeHotkeys = () => {
  const appStore = useAppStoreApi();
  const toggleInteractive = (0, import_react58.useCallback)(() => {
    const dispatch = appStore.getState().dispatch;
    dispatch({
      type: "setUi",
      ui: (ui) => ({
...
var HeaderInner = ({
  ...
  const dispatch = useAppStore((s2) => s2.dispatch);
  const appStore = useAppStoreApi();
  const defaultHeaderRender = (0, import_react59.useMemo)(() => {
    if (renderHeader) {
      console.warn(
  ...
  const defaultHeaderActionsRender = (0, import_react59.useMemo)(() => {
  ...
  const [menuOpen, setMenuOpen] = (0, import_react59.useState)(false);
  ...
  const toggleSidebars = (0, import_react59.useCallback)(
    (sidebar) => {
...
var Header = (0, import_react59.memo)(HeaderInner);
init_react_import();
init_react_import();
...
var ViewportControls = ({
  ...
  const zoomOptions = (0, import_react62.useMemo)(
    () => [
      ...defaultZoomOptions,
  ...
  const [activeViewport, setActiveViewport] = (0, import_react62.useState)(
    uiViewports.current.width
  );
  (0, import_react62.useEffect)(() => {
    setActiveViewport(uiViewports.current.width);
  }, [uiViewports.current]);
  const [isExpanded, setIsExpanded] = (0, import_react62.useState)(false);
...
init_react_import();
var FrameContext = (0, import_react63.createContext)(null);
var FrameProvider = ({
  children
}) => {
  const frameRef = (0, import_react63.useRef)(null);
...
var useCanvasFrame = () => {
  const context = (0, import_react63.useContext)(FrameContext);
  if (context === null) {
...
var Canvas = () => {
  ...
  const [showTransition, setShowTransition] = (0, import_react61.useState)(false);
  const isResizingRef = (0, import_react61.useRef)(false);
  const defaultRender = (0, import_react61.useMemo)(() => {
    const PuckDefault = ({ children }) => (0, import_jsx_runtime51.jsx)(import_jsx_runtime51.Fragment, { children });
    return PuckDefault;
  }, []);
  const CustomPreview = (0, import_react61.useMemo)(
    () => overrides.preview || defaultRender,
    [overrides]
  );
  const getFrameDimensions = (0, import_react61.useCallback)(() => {
    if (frameRef.current) {
  ...
  const [showLoader, setShowLoader] = (0, import_react61.useState)(false);
  (0, import_react61.useEffect)(() => {
    setTimeout(() => {
      setShowLoader(true);
    }, 500);
...
function useSidebarResize(position, dispatch) {
  const [width, setWidth] = (0, import_react64.useState)(null);
  const sidebarRef = (0, import_react64.useRef)(null);
  ...
  const handleResizeEnd = (0, import_react64.useCallback)(
    (width2) => {
      dispatch({
        type: "setUi",
        ui: {
...
var useDeleteHotkeys = () => {
  const appStore = useAppStoreApi();
  const deleteSelectedComponent = (0, import_react66.useCallback)(
    (e2) => {
      var _a5;
...
var Layout = ({ children }) => {
  ...
  const appStoreApi = useAppStoreApi();
  const [mobilePanelHeightMode, setMobilePanelHeightMode] = (0, import_react56.useState)("toggle");
  const hasLegacySideBarPlugin = (0, import_react56.useMemo)(
...
var propsContext = (0, import_react45.createContext)({});
function PropsProvider(props) {
  return (0, import_jsx_runtime59.jsx)(propsContext.Provider, { value: props, children: props.children });
}
var usePropsContext = () => (0, import_react45.useContext)(propsContext);
function PuckProvider({ children }) {
  ...
  const iframe = (0, import_react45.useMemo)(
    () => __spreadValues({
      enabled: true,
      waitForStyles: true
    }, _iframe),
  ...
  const [generatedAppState] = (0, import_react45.useState)(() => {
    var _a5, _b3, _c4;
  ...
  const [blendedHistories] = (0, import_react45.useState)(
    [
  ...
  const initialHistoryIndex = (0, import_react45.useMemo)(() => {
  ...
  const loadedFieldTransforms = (0, import_react45.useMemo)(() => {
  ...
  const generateAppStore = (0, import_react45.useCallback)(
    (state) => {
      return {
        instanceId,
        state,
  ...
  const [appStore] = (0, import_react45.useState)(
  ...
  const previousData = (0, import_react45.useRef)(null);
  (0, import_react45.useEffect)(() => {
    return appStore.subscribe(
      (s2) => s2.state.data,
      (data) => {
