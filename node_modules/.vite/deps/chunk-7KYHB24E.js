...
// node_modules/@puckeditor/core/dist/chunk-PMXRXC2B.mjs
...
function walkAppState(state, config, mapContent = (content) => content, mapNodeOrSkip = (item) => item) {
  ...
  const processContent = (path, zoneCompound, content, zoneType, newId) => {
    ...
    const newContent2 = mappedContent.map(
      (zoneChild, index2) => processItem(zoneChild, [...path, newZoneCompound], index2)
    );
  ...
  const processItem = (item, path, index2) => {
    const mappedItem = mapNodeOrSkip(item, path, index2);
...
// node_modules/@puckeditor/core/dist/chunk-37HTE4KO.mjs
init_react_import();
init_react_import();
...
init_react_import();
init_react_import();
var insert = (list, index2, item) => {
  const result = Array.from(list || []);
  result.splice(index2, 0, item);
  return result;
};
init_react_import();
...
function duplicateAction(state, action, appStore) {
  ...
  const modified = walkAppState(
    ...
    (childItem, path, index2) => {
      ...
      if (zoneCompound === action.sourceZone && index2 === action.sourceIndex + 1) {
        return newItem;
      }
...
// node_modules/@puckeditor/core/node_modules/fast-equals/dist/esm/index.mjs
...
// node_modules/@puckeditor/core/dist/chunk-MDUBGHWF.mjs
init_react_import();
...
// node_modules/@puckeditor/core/dist/chunk-UMTU6EA7.mjs
...
// node_modules/@puckeditor/core/node_modules/@radix-ui/react-popover/dist/index.mjs
var React33 = __toESM(require_react(), 1);

// node_modules/@puckeditor/core/node_modules/@radix-ui/primitive/dist/index.mjs
...
// node_modules/@puckeditor/core/node_modules/@radix-ui/react-compose-refs/dist/index.mjs
...
// node_modules/@puckeditor/core/node_modules/@radix-ui/react-context/dist/index.mjs
...
// node_modules/@puckeditor/core/node_modules/@radix-ui/react-popover/node_modules/@radix-ui/react-dismissable-layer/dist/index.mjs
var React8 = __toESM(require_react(), 1);

// node_modules/@puckeditor/core/node_modules/@radix-ui/react-popover/node_modules/@radix-ui/react-primitive/dist/index.mjs
var React5 = __toESM(require_react(), 1);
var ReactDOM = __toESM(require_react_dom(), 1);

// node_modules/@puckeditor/core/node_modules/@radix-ui/react-slot/dist/index.mjs
...
// node_modules/@puckeditor/core/node_modules/@radix-ui/react-use-callback-ref/dist/index.mjs
...
// node_modules/@puckeditor/core/node_modules/@radix-ui/react-use-escape-keydown/dist/index.mjs
...
// node_modules/@puckeditor/core/node_modules/@radix-ui/react-focus-guards/dist/index.mjs
...
// node_modules/@puckeditor/core/node_modules/@radix-ui/react-popover/node_modules/@radix-ui/react-focus-scope/dist/index.mjs
...
// node_modules/@puckeditor/core/node_modules/@radix-ui/react-id/dist/index.mjs
var React12 = __toESM(require_react(), 1);

// node_modules/@puckeditor/core/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
...
// node_modules/@puckeditor/core/node_modules/@radix-ui/react-popover/node_modules/@radix-ui/react-popper/dist/index.mjs
...
// node_modules/@puckeditor/core/node_modules/@radix-ui/react-popover/node_modules/@radix-ui/react-popper/node_modules/@radix-ui/react-arrow/dist/index.mjs
...
// node_modules/@puckeditor/core/node_modules/@radix-ui/react-use-size/dist/index.mjs
...
// node_modules/@puckeditor/core/node_modules/@radix-ui/react-popover/node_modules/@radix-ui/react-portal/dist/index.mjs
...
// node_modules/@puckeditor/core/node_modules/@radix-ui/react-popover/node_modules/@radix-ui/react-presence/dist/index.mjs
...
// node_modules/@puckeditor/core/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
...
var useMonitorHotkeys = () => {
  (0, import_react10.useEffect)(() => monitorHotkeys(document), []);
};
...
var createHistorySlice = (set, get) => {
  const record = debounce((state) => {
    const { histories, index: index2 } = get().history;
    const history = {
      state,
      id: generateId("history")
    };
    const newHistories = [...histories.slice(0, index2 + 1), history];
    set({
  ...
  return {
    ...
    setHistoryIndex: (index2) => {
      var _a;
      const { dispatch, history } = get();
      dispatch({
        type: "set",
        state: ((_a = history.histories[index2]) == null ? void 0 : _a.state) || history.initialAppState
      });
      set({ history: __spreadProps(__spreadValues({}, history), { index: index2 }) });
    },
    record
  };
};
function useRegisterHistorySlice(appStore, {
  ...
  (0, import_react9.useEffect)(
    ...
    [histories, index2, initialAppState]
  );
  const back = () => {
...
var useRegisterFieldsSlice = (appStore, id) => {
  const resolveFields = (0, import_react12.useCallback)(
            ...
            resolveComponentData2(childItem, "load").then((resolved) => {
              ...
              if (node && resolved.didChange) {
                if (resolved.node.props.id === "root") {
                  ...
                  const index2 = parentZone.contentIds.indexOf(
...
init_react_import();
var ControlContext = (0, import_react13.createContext)({});
var useControlContext = () => {
  return (0, import_react13.useContext)(ControlContext);
};
init_react_import();
init_react_import();
init_react_import();
...
init_react_import();
var replace = (list, index2, newItem) => {
  const result = Array.from(list);
  result.splice(index2, 1);
  result.splice(index2, 0, newItem);
  return result;
};
init_react_import();
init_react_import();
...
var parse3 = function parse22(raw) {
...
var calculateBox = function calculateBox2(borderBox, styles) {
  var margin = {
    top: parse3(styles.marginTop),
    right: parse3(styles.marginRight),
    bottom: parse3(styles.marginBottom),
    left: parse3(styles.marginLeft)
  };
  var padding = {
    top: parse3(styles.paddingTop),
    right: parse3(styles.paddingRight),
    bottom: parse3(styles.paddingBottom),
    left: parse3(styles.paddingLeft)
  };
  var border = {
    top: parse3(styles.borderTopWidth),
    right: parse3(styles.borderRightWidth),
    bottom: parse3(styles.borderBottomWidth),
    left: parse3(styles.borderLeftWidth)
  };
  return createBox({
    borderBox,
    margin,
...
var Item = ({
  ...
  return (0, import_jsx_runtime10.jsx)("button", { className: getItemClassName({ isSelected }), onClick, children });
};
var Select = ({
  children,
  options,
  ...
  return (0, import_jsx_runtime10.jsx)(
    "div",
    {
      ...
      children: (0, import_jsx_runtime10.jsxs)(Popover, { open, onOpenChange: setOpen, children: [
        hasOptions ? (0, import_jsx_runtime10.jsx)(PopoverTrigger, { asChild: true, children: (0, import_jsx_runtime10.jsxs)("button", { className: getClassName("button"), children: [
          (0, import_jsx_runtime10.jsx)("span", { className: getClassName("buttonIcon"), children }),
          (0, import_jsx_runtime10.jsx)(ChevronDown, { size: 12 })
        ] }) }) : (0, import_jsx_runtime10.jsx)("div", { children: (0, import_jsx_runtime10.jsxs)("div", { className: getClassName("button"), children: [
          (0, import_jsx_runtime10.jsx)("span", { className: getClassName("buttonIcon"), children }),
          (0, import_jsx_runtime10.jsx)(ChevronDown, { size: 12 })
        ] }) }),
        options.length > 0 && (0, import_jsx_runtime10.jsx)(PopoverPortal, { children: (0, import_jsx_runtime10.jsx)(PopoverContent, { align: "start", children: (0, import_jsx_runtime10.jsx)("ul", { className: getClassName("items"), "data-puck-rte-menu": true, children: options.map((option) => {
          const Icon2 = option.icon;
          return (0, import_jsx_runtime10.jsx)("li", { children: (0, import_jsx_runtime10.jsxs)(
            Item,
            {
              ...
              children: [
                Icon2 && (0, import_jsx_runtime10.jsx)("div", { className: getItemClassName("icon"), children: (0, import_jsx_runtime10.jsx)(Icon2, { size: 16 }) }),
                option.label
              ]
            }
          ) }, option.value);
...
function SelectControl({
  ...
  var _a, _b;
  const { inline: inline3, readOnly } = useControlContext();
  const optionsByValue = (0, import_react14.useMemo)(
    () => options.reduce(
  ...
  return (0, import_jsx_runtime11.jsx)(
    Select,
    {
      ...
      value,
      defaultValue,
      mode: inline3 ? "actionBar" : "standalone",
      disabled: readOnly,
      children: (0, import_jsx_runtime11.jsx)(Node2, {})
    }
  );
}
...
@puckeditor/core/dist/chunk-UMTU6EA7.mjs:
  (*! Bundled license information:
  ...
  *)
*/
//# sourceMappingURL=chunk-7KYHB24E.js.map
