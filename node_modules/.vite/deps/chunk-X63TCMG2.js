...
// node_modules/@puckeditor/core/dist/chunk-2CNEFIQP.mjs
init_react_import();
...
var PuckRichText = Extension.create({
  ...
  addExtensions() {
    const extensions = [];
    const options2 = __spreadValues(__spreadValues({}, this.options), defaultPuckRichTextOptions);
    if (options2.bold !== false) {
      extensions.push(Bold.configure(options2.bold));
    }
    if (options2.blockquote !== false) {
      extensions.push(Blockquote.configure(options2.blockquote));
    }
    if (options2.code !== false) {
      extensions.push(Code.configure(options2.code));
    }
    if (options2.codeBlock !== false) {
      extensions.push(CodeBlock.configure(options2.codeBlock));
    }
    if (options2.document !== false) {
      extensions.push(Document.configure(options2.document));
    }
    if (options2.hardBreak !== false) {
      extensions.push(HardBreak.configure(options2.hardBreak));
    }
    if (options2.heading !== false) {
      extensions.push(Heading.configure(options2.heading));
    }
    if (options2.horizontalRule !== false) {
      extensions.push(HorizontalRule.configure(options2.horizontalRule));
    }
    if (options2.italic !== false) {
      extensions.push(Italic.configure(options2.italic));
    }
    if (options2.listItem !== false) {
      extensions.push(ListItem.configure(options2.listItem));
      if (options2.bulletList !== false) {
        extensions.push(BulletList.configure(options2.bulletList));
      }
      if (options2.orderedList !== false) {
        extensions.push(OrderedList.configure(options2.orderedList));
      }
    }
    if (options2.listKeymap !== false) {
      extensions.push(ListKeymap.configure(options2 == null ? void 0 : options2.listKeymap));
    }
    if (options2.link !== false) {
      extensions.push(Link.configure(options2 == null ? void 0 : options2.link));
    }
    if (options2.paragraph !== false) {
      extensions.push(Paragraph.configure(options2.paragraph));
    }
    if (options2.strike !== false) {
      extensions.push(Strike.configure(options2.strike));
    }
    if (options2.text !== false) {
      extensions.push(Text2.configure(options2.text));
    }
    if (options2.textAlign !== false) {
      extensions.push(index_default.configure(options2.textAlign));
    }
    if (options2.underline !== false) {
      extensions.push(Underline.configure(options2 == null ? void 0 : options2.underline));
    }
    return extensions;
  }
});
...
//# sourceMappingURL=chunk-X63TCMG2.js.map
